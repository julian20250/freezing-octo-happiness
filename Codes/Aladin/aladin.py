...
def main():
  ...
  l2 = Label(burn, text="If this is your first time I recommend to type 'Help!', where you can find a simple guide of"
	     " how to use Aladin.")
  l3= Label(burn, text="To plot in 2D the objects click me! -->")
  l4 = Label(burn, text="To show the Help click me! -->")
  l5 = Label(burn, text="To exit click here! -->")
  b1 = Button(burn, text = "Quit", command=andother)
  b2 = Button(burn, text = "Help!", command=helper)  
  b3 = Button(burn, text = "Plot", command=plot2d)
  ...
  l5.grid(row=100, sticky=E)
  b1.grid(row = 100, column = 1, sticky=W)
