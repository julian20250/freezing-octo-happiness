...
public class Ricardo extends ObjetoMovil implements KeyListener {
    ...
    public Ricardo(double x, double y, double width, double height, Escenario escenario, LlaveVerde v_contador,
            ...
            Won won, LlaveAmarilla llaveAmarilla, LlaveAzul llaveAzul, LlaveVerde llaveVerde,
            LlaveRoja llaveRoja) {
        ...
        this.won = won;
        this.llaveAmarilla=llaveAmarilla;
        this.llaveAzul=llaveAzul;
        this.llaveVerde=llaveVerde;
        this.llaveRoja=llaveRoja;
    }
    ...
    public void keyPressed(KeyEvent e) {
        ...
        switch (tecla) {
            ...
            case KeyEvent.VK_R:
                ...
                eva.x = 120d;
                eva.y = 0d;
                eva.direccion = TipoDireccion.abajo;
                eva.hate = true;
                valorPuntaje.score = 20000;
                tiempoRestante.minutos = 1;
                tiempoRestante.segundos = 30;
                tiempoRestante.algo = true;
                valorPuntaje.continuar = true;
                tok1 = false;
                tok2 = false;
                tok3 = false;
                tok4 = false;
                ...
                b_contador.setVisible(false);
                    ...
                    llaveVerde.setColisionable(true);

                    llaveAzul.setColisionable(true);

                    llaveAmarilla.setColisionable(true);

                    llaveRoja.setColisionable(true);                               
        ...
        for (ObjetoGrafico o : quienes) {
            ...
            if (o instanceof EdificioGris) {
                ...
                tiempoRestante.algo = false;
                valorPuntaje.continuar = false;
                won.setVisible(true);
            }
        }
        if (tok3==true) {
